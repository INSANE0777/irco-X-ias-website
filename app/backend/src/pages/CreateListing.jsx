...
const handleChangeDescription = (e)=>{
    ...
    const handlePost = async (e) => {
        e.preventDefault();
        try {
            // Create a new FormData object ro handle file uploads
  ...
  return (
    ...
    <section className='max-padd-container py-10'>
        ...
        <div className='hide-scrollbar flex gap-x-1 bg-white ring-1 
        ring-slate-400/5 shadow-sm rounded-full px-2 py-3 
        overflow-x-auto mb-8'>
            {categories.map((item)=>(
                <div 
                    key={item.label}
                    onClick={()=>setCategory(item.label)}
                    className='flexCenter flex-col gap-2 
                    p-2 rounded-xl cursor-pointer min-w-24 xl:min-w-32'
                    style={{ flexShrink: 0 }} // Prevent Shrinking
                >
                    <div className="text-secondary rounded-full 
                    h-10 w-10 p-2 flexCenter text-lg" 
                    style={{backgroundColor: `${item.color}`}}
                    >
                        {item.icon}
                    </div>
                    <p className={`${category === item.label ? 
                    "text-secondary" : ""} medium-14`}>{item.label}</p>
                </div>
            ))}
        </div>
        ...
        <div className="flex-col flex xl:flex-row gap-x-16">
            ...
            <div className="flex-1">
                <h4 className="h4 my-4">What is the type of your place?
                </h4>
            ...
            <div className="flex-1 mb-4">
                ...
                <div>
                    <div>
                        ...
                        border-none mb-2 rounded ring-1 ring-slate-900/5'
                        />
                    </div>
                </div>
                <div>
                ...
                <div>
                    <div className="w-1/2">
                        <h5 className="h5">State/Province: </h5>
                        <input
                            onChange={handleChangeLocation}
                            ...
                            required
                            className="bg-white p-2 text-sm outline-none 
                            border-none mb-2 rounded ring-1 ring-slate-900/5"/>
                    </div>
                    <div className="w-1/2">
        ...
        {/* Essentials */}
        <h4 className='h4 my-4'>Provide some essentials details about 
            your place?</h4>
        <div className='flex flex-wrap gap-3 mb-6'>
            <div className='flexCenter gap-x-4 ring-1 ring-slate-900/5 p-2 
            rounded'>
                <h5>Guests</h5>
                <div className="flexCenter gap-x-2 bg-white">
                    ...
                    className="h-6 w-6 text-xl p-1 rounded
                    cursor-pointer"
                    />
                    <p>{guestCount}</p>
                    <FaPlus onClick={() => setGuestCount(guestCount + 1)} 
                        className='h-6 w-6 text-xl bg-secondary text-white
            ...
            rounded'>
                ...
                <div className="flexCenter gap-x-2 bg-white">
                    ...
                    />
                    <p>{bedroomCount}</p>
                    <FaPlus onClick={() => setBedroomCount(bedroomCount + 1)} 
                        className='h-6 w-6 text-xl bg-secondary text-white
                        rounded cursor-pointer'/>
                </div>
            </div>
            ...
            rounded'>
                ...
                <div className="flexCenter gap-x-2 bg-white">
                    ...
                    />
                    <p>{bedCount}</p>
                    <FaPlus onClick={() => setBedCount(bedCount + 1)} 
                        className='h-6 w-6 text-xl bg-secondary text-white
                        rounded cursor-pointer'/>
                </div>
            </div>
            ...
            rounded'>
                ...
                <div className="flexCenter gap-x-2 bg-white">
                    ...
                    />
                    <p>{bathroomCount}</p>
                    <FaPlus onClick={() => setBathroomCount(bathroomCount + 1)} 
                        className='h-6 w-6 text-xl bg-secondary text-white
                        rounded cursor-pointer'/>
                </div>
            </div>
        ...
        <div className='my-10'>
            ...
            <DragDropContext onDragEnd={handleDragPhoto}>
                <Droppable droppableId='photos' direction='horizontal'>
                    {(provided)=>(
                        ...
                        p-4 bg-gray-50 rounded-lg shadow-lg'
                        ...
                        >
                            ...
                            cursor-pointer">
                                <div className='h-52 w-full flexCenter'>
                                    ...
                                    <p className='text-gray-500 group-hover:text-grey-700'>
                            ...
                            {photos.length >= 1 && (
                                <>
                                    ...
                                    />
                                    <label htmlFor='imageUpload' className="group
                                    flexCenter flex-col border-2 border-dashed
            ...
            <h4 className='h4 my-5'>
                How would your characterize the charm and excitement of 
                your property?
            </h4>
            <div className="">
