  ...
  return (
    <div className='absolute h-full w-full bg-black/40 z-50 flexCenter'>
      <div>
        ...
        className='flex flex-col gap-y-2.5 bg-white w-[366px] p-7 
        rounded-xl shadow-md text-[14px]' >
          ...
          />
          <label htmlFor="image">
            <div className='flexCenter ring-1 ring-slate-900/10 p-1 
            h-16 w-16 rounded'>
          ...
          rounded mt-2'>Register</button>
          <div className='text-gray-30'>
            Already have an account? <Link to={"/login"} className='text-secondary 
            cursor-pointer pl-1'>
              Login
            </Link>
          </div>
